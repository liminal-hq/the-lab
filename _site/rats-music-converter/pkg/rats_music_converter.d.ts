 ...
 */
export function convert_audio(samples: Float32Array, sample_rate: number, num_channels: number): string;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
    readonly memory: WebAssembly.Memory;
    readonly convert_audio: (a: number, b: number, c: number, d: number) => [number, number];
