    ...
    startMusic() {
        ...
        this.musicInterval = setInterval(() => {
            ...
            if (this.level === 'SUBWAY') {
                ...
                } else if (this.cycle >= DISTRICT_THRESHOLDS.COMMERCIAL) {
                    // Commercial (Purple, bridging): Syncopated off-beats
                    currentScale = [440, 493.88, 523.25, 587.33, 659.25, 783.99, 880]; // Keep Aeolian
                    bassNoteMod = 0.85;
                    squeakFreqMod = 600;
                    beatDrums = beat % 4 === 1; // Off-beat
