/* @ts-self-types="./rats_music_converter.d.ts" */
 ...
 * @returns {string}
 */
export function convert_audio(samples, sample_rate, num_channels) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passArrayF32ToWasm0(samples, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.convert_audio(ptr0, len0, sample_rate, num_channels);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./rats_music_converter_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rats_music_converter_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
