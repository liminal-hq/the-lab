...
* Squeak now functions as a unified area-of-effect defensive mechanic that both scares birds and shatters incoming projectiles simultaneously. It's critical to ensure state updates from such inputs apply comprehensively before the consumption flag resets.
