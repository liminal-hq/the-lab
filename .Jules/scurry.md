...
## Squeak Shattering
- **Learning**: Expanding the existing Squeak mechanic (Swipe Down/S key) to also shatter falling projectiles creates a richer, more responsive world without adding any new buttons or complex control logic. Players organically discover it while dealing with birds.
