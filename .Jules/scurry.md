...
* Adding secondary utility (like projectile shattering) to an expressive action (like Squeak) deepens gameplay mechanics without increasing control overhead.
