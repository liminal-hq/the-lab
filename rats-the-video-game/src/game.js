...
function update() {
    ...
    // Squeak Logic (Scaring birds & Deflecting turds)
    if (state.input.squeakPressed) {
        ...
        // Visual feedback (Sonic wave!)
        spawnParticles(state.rat.x, state.rat.y + 10, '#FFF', 15);
